                                    ...
                                    <div className="">
                                            ...
                                            <div className="w-full h-full flex flex-col gap-2 justify-between">
                                                ...
                                                <div className="flex items-center gap-2">
                                                    <Avatar className="h-10 w-10 rounded-full">
                                                        <AvatarImage src={data.Users.avatar} alt={data.Users.nickName} />
                                                        <AvatarFallback className="rounded-full text-xs">
                                                            {data.Users.nickName.slice(0, 2).toUpperCase()}
                                                        </AvatarFallback>
                                                    </Avatar>
                                                    ...
                                                    <div className="flex flex-1 items-center gap-2 py-1.5 text-left text-sm">
                                                        ...
                                                        <div className="grid flex-1 text-left text-sm leading-tight">
                                                            <span className="truncate font-medium">{data.Users.nickName}</span>
                                        ...
                                        <div className="">
                                            <div className="grid gap-0 [grid-template-columns:50px_1fr]">
                                                <div className="sticky top-0 self-start p-2 flex flex-col items-center justify-center">
                                                    <FacebookIcon />
                                                    <XIcon />
                                                    <InstagramIcon />
                                                    <RedditIcon />
                                                ...
                                                <div className="bg-amber-900">
                                                    <div className="h-[1000px] bg-amber-950">content</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
