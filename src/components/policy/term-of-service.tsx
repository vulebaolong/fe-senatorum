...
import { AlertTriangle, ArrowLeft, BookOpen, Calendar, Download, Eye, FileText, Info, Scale, Shield, Users } from "lucide-react";
            ...
            <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 h-[calc(100vh-var(--header-height))] overflow-y-auto">
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
                    ...
                    <Card className="lg:col-span-1 h-fit sticky top-0 rounded-lg border bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-700">
                        <h3 className="font-semibold px-4 flex items-center gap-2 text-gray-900 dark:text-gray-100">
                                    ...
                                    <a
                                        ...
                                        className={[
                                            ...
                                            isActive
                                                ...
                                                : "text-gray-600 hover:text-gray-900 hover:bg-gray-50 dark:text-gray-400 dark:hover:text-gray-100 dark:hover:bg-gray-800/60",
                                        ].join(" ")}
                                        onClick={(e) => {
                                            e.preventDefault();
                        ...
                        <div className="p-8 prose prose-lg max-w-none dark:prose-invert">
                            ...
                            <section id="acceptance" className="mb-12 scroll-mt-24">
                                ...
                                <div className="text-gray-700 dark:text-gray-300 leading-relaxed space-y-4">
                                    <p>
                                        By accessing or using Senatorum (the "Service"), you agree to be bound by these Terms of Service ("Terms"). If
                                        you do not agree to these Terms, do not use the Service.
                                    </p>
                                    <p>
                                        These Terms apply to all users of the Service, including without limitation users who are visitors, browsers,
                            ...
                            <section id="description" className="mb-12 scroll-mt-24">
                                ...
                                <div className="text-gray-700 dark:text-gray-300 leading-relaxed">
                                    <p>
                                        Senatorum is a social networking platform that provides users with tools to connect, communicate, and share
                                        content in a positive, constructive environment. Our Service includes messaging, content sharing, community
                                        features, and related functionalities.
                                    </p>
                                </div>
                            </section>
                                    ...
                                    <div className="flex">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-red-700 dark:text-red-200 text-sm mt-1">
                                                Violation of these content policies may result in content removal, account suspension, or permanent
                                                ban.
                                            </p>
                                        </div>
                                    </div>
                                            ...
                                            <div className="bg-gray-50 dark:bg-gray-800/60 border border-gray-200 dark:border-gray-700 p-4 rounded-lg">
                                                ...
                                                <div className="mt-4 p-3 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded">
                                                    <p className="text-sm text-blue-800 dark:text-blue-200">
                                                        <strong>Educational Exception:</strong> Educational and historical content about conflicts may
                                                        be permitted when clearly marked as educational, sourced from credible sources, presented
                                                        without graphic imagery, and includes appropriate content warnings.
                                                    </p>
                                                </div>
                                            </div>

                                            <div className="bg-gray-50 dark:bg-gray-800/60 border border-gray-200 dark:border-gray-700 p-4 rounded-lg">
                                                <h4 className="font-semibold text-gray-900 dark:text-gray-100 mb-2">General Prohibited Content:</h4>
                                                <ul className="list-disc list-inside space-y-1 text-sm">
                            ...
                            <section id="moderation" className="mb-12 scroll-mt-24">
                                ...
                                <div className="text-gray-700 dark:text-gray-300 leading-relaxed space-y-6">
                                    ...
                                    <div>
                                        ...
                                        <p className="mb-3">
                                            Users can report violations through our in-app reporting system. We will review reports promptly and take
                                            appropriate action.
                                        </p>
                            ...
                            <section id="ip" className="mb-12 scroll-mt-24">
                                ...
                                <div className="text-gray-700 dark:text-gray-300 leading-relaxed space-y-6">
                                    <div>
                                        ...
                                        <p>
                                            The Service, including its design, features, and underlying technology, is owned by us and protected by
                            ...
                            <section id="disclaimers" className="mb-12 scroll-mt-24">
                                ...
                                <div className="text-gray-700 dark:text-gray-300 leading-relaxed space-y-6">
                                    ...
                                    <div>
                                        <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-3">10.2 Limitation of Liability</h3>
                            ...
                            <section id="compliance" className="mb-12 scroll-mt-24">
                                ...
                                <div className="text-gray-700 dark:text-gray-300 leading-relaxed space-y-6">
                                    ...
                                    <div>
                                        <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-3">13.2 Government Cooperation</h3>
                                    ...
                                    <div>
                                        ...
                                        <p>
                                            We may provide user information to authorities when legally required or to protect our rights and users'
                                            safety.
                                        </p>
                                    </div>
                                </div>
                            ...
                            <section id="additional" className="mb-12 scroll-mt-24">
                                <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-4 flex items-center gap-3">
                                ...
                                <div className="bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-6">
                                    <div className="text-center">
                                        ...
                                        <p className="text-gray-700 dark:text-gray-300 mb-4">
                                            By using Senatorum, you acknowledge that you have read, understood, and agree to be bound by these Terms
                                            of Service.
                                        </p>
