                            ...
                            <div className="p-8 prose prose-lg max-w-none">
                                ...
                                <section id="eligibility" className="mb-12">
                                    ...
                                    <div className="text-gray-700 leading-relaxed space-y-6">
                                        <div>
                                            <h3 className="text-lg font-semibold text-gray-900 mb-3">3.1 Age Requirements</h3>
                                        ...
                                        <div>
                                            <h3 className="text-lg font-semibold text-gray-900 mb-3">3.2 Account Requirements</h3>
                                            <ul className="list-disc list-inside space-y-2">
                                ...
                                <section id="prohibited" className="mb-12">
                                    ...
                                    <div className="text-gray-700 leading-relaxed space-y-6">
                                        <div>
                                            <h3 className="text-lg font-semibold text-gray-900 mb-3">4.1 Content Restrictions</h3>
                                            <p className="mb-4">You may not post, upload, or share content that:</p>

                                            <div className="space-y-6">
                                                <div className="bg-gray-50 p-4 rounded-lg">
                                                    <h4 className="font-semibold text-gray-900 mb-2">Political Content:</h4>
                                                ...
                                                <div className="bg-gray-50 p-4 rounded-lg">
                                                    <h4 className="font-semibold text-gray-900 mb-2">Religious Content:</h4>
                                                    <ul className="list-disc list-inside space-y-1 text-sm">
                                                ...
                                                <div className="bg-gray-50 p-4 rounded-lg">
                                                    <h4 className="font-semibold text-gray-900 mb-2">War and Conflict Content:</h4>
                                                    <ul className="list-disc list-inside space-y-1 text-sm">
                                                ...
                                                <div className="bg-gray-50 p-4 rounded-lg">
                                                    <h4 className="font-semibold text-gray-900 mb-2">General Prohibited Content:</h4>
                                                    <ul className="list-disc list-inside space-y-1 text-sm">
                                        ...
                                        <div>
                                            <h3 className="text-lg font-semibold text-gray-900 mb-3">4.2 Prohibited Conduct</h3>
                                ...
                                <section id="moderation" className="mb-12">
                                    ...
                                    <div className="text-gray-700 leading-relaxed space-y-6">
                                        <div>
                                            <h3 className="text-lg font-semibold text-gray-900 mb-3">5.1 Our Rights</h3>
                                        ...
                                        <div>
                                            <h3 className="text-lg font-semibold text-gray-900 mb-3">5.2 Reporting and Review System</h3>
                                            <p className="mb-3">
                                            ...
                                            <div className="bg-blue-50 p-4 rounded-lg">
                                                <h4 className="font-semibold text-blue-900 mb-2">Content Review Process:</h4>
                                        ...
                                        <div>
                                            <h3 className="text-lg font-semibold text-gray-900 mb-3">5.3 Appeals Process</h3>
                                            <p>
                                ...
                                <section id="content" className="mb-12">
                                    ...
                                    <div className="text-gray-700 leading-relaxed space-y-6">
                                        <div>
                                            <h3 className="text-lg font-semibold text-gray-900 mb-3">6.1 Ownership</h3>
                                        ...
                                        <div>
                                            <h3 className="text-lg font-semibold text-gray-900 mb-3">6.3 Responsibility</h3>
                                ...
                                <section id="termination" className="mb-12">
                                    ...
                                    <div className="text-gray-700 leading-relaxed space-y-6">
                                        <div>
                                            <h3 className="text-lg font-semibold text-gray-900 mb-3">8.1 Termination by You</h3>
                                            <p>You may delete your account at any time through account settings.</p>
                                        </div>

                                        <div>
                                            <h3 className="text-lg font-semibold text-gray-900 mb-3">8.2 Termination by Us</h3>
                                        ...
                                        <div>
                                            <h3 className="text-lg font-semibold text-gray-900 mb-3">8.3 Effect of Termination</h3>
                                ...
                                <section id="ip" className="mb-12">
                                    ...
                                    <div className="text-gray-700 leading-relaxed space-y-6">
                                        <div>
                                            <h3 className="text-lg font-semibold text-gray-900 mb-3">9.1 Our Rights</h3>
                                            <p>
                                        ...
                                        <div>
                                            <h3 className="text-lg font-semibold text-gray-900 mb-3">9.2 Respect for Others' Rights</h3>
                                            <p>
                                        ...
                                        <div>
                                            <h3 className="text-lg font-semibold text-gray-900 mb-3">9.3 Trademark Policy</h3>
                                    ...
                                    <div className="text-gray-700 leading-relaxed space-y-6">
                                        ...
                                        <div>
                                            ...
                                            <div className="bg-yellow-50 p-4 rounded-lg border border-yellow-200">
                                                <p className="font-semibold text-yellow-800 mb-2">TO THE MAXIMUM EXTENT PERMITTED BY LAW:</p>
                                        ...
                                        <div>
                                            <h3 className="text-lg font-semibold text-gray-900 mb-3">10.3 Indemnification</h3>
                                            <p>
                                ...
                                <section id="disputes" className="mb-12">
                                    ...
                                    <div className="text-gray-700 leading-relaxed space-y-6">
                                        <div>
                                            <h3 className="text-lg font-semibold text-gray-900 mb-3">11.1 Governing Law</h3>
                                            <p>
                                        ...
                                        <div>
                                            <h3 className="text-lg font-semibold text-gray-900 mb-3">11.2 Dispute Resolution Process</h3>
                                        ...
                                        <div>
                                            <h3 className="text-lg font-semibold text-gray-900 mb-3">11.3 Jurisdiction</h3>
                                ...
                                <section id="general" className="mb-12">
                                    ...
                                    <div className="text-gray-700 leading-relaxed space-y-6">
                                        <div>
                                            <h3 className="text-lg font-semibold text-gray-900 mb-3">12.1 Updates to Terms</h3>
                                            <ul className="list-disc list-inside space-y-1">
                                        ...
                                        <div>
                                            <h3 className="text-lg font-semibold text-gray-900 mb-3">12.2 Severability</h3>
                                            <p>If any provision is found invalid, the remaining provisions remain in effect.</p>
                                        </div>

                                        <div>
                                            <h3 className="text-lg font-semibold text-gray-900 mb-3">12.3 Entire Agreement</h3>
                                            <p>These Terms, together with our Privacy Policy, constitute the entire agreement between you and us.</p>
                                        </div>

                                        <div>
                                            <h3 className="text-lg font-semibold text-gray-900 mb-3">12.4 Assignment</h3>
                                            <p>We may assign these Terms; you may not assign your rights without our consent.</p>
                                        </div>

                                        <div>
                                            <h3 className="text-lg font-semibold text-gray-900 mb-3">12.5 Waiver</h3>
                                ...
                                <section id="compliance" className="mb-12">
                                    ...
                                    <div className="text-gray-700 leading-relaxed space-y-6">
                                        <div>
                                            <h3 className="text-lg font-semibold text-gray-900 mb-3">13.1 Legal Compliance</h3>
                                            <p>You agree to comply with all applicable laws and regulations when using the Service.</p>
                                        </div>

                                        <div>
                                            <h3 className="text-lg font-semibold text-gray-900 mb-3">13.2 Government Cooperation</h3>
                                            <p>We may cooperate with law enforcement and government agencies as required by law.</p>
                                        </div>

                                        <div>
                                            <h3 className="text-lg font-semibold text-gray-900 mb-3">13.3 Data Requests</h3>
                                            <p>
                                ...
                                <section id="additional" className="mb-12">
                                    ...
                                    <div className="text-gray-700 leading-relaxed space-y-6">
                                        <div>
                                            <h3 className="text-lg font-semibold text-gray-900 mb-3">14.1 Beta Features</h3>
                                            <p>Some features may be in beta testing and provided without warranty.</p>
                                        </div>

                                        <div>
                                            <h3 className="text-lg font-semibold text-gray-900 mb-3">14.2 Third-Party Services</h3>
                                            <p>We are not responsible for third-party services or content linked from our Service.</p>
                                        </div>

                                        <div>
                                            <h3 className="text-lg font-semibold text-gray-900 mb-3">14.3 Export Controls</h3>
